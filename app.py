...
# FIX 1: Use __name__ instead of name
app = Flask(__name__)
app.secret_key = "nexgenops-owner-secret"

# DATABASE CONNECTION
def db():
    # check_same_thread=False is used for SQLite in multi-threaded Flask apps
...
# APPROVE / SUSPEND / CHANGE PLAN
# FIX 2: Correct route parameter syntax <int:company_id>
